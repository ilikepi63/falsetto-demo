...
<head>
    <title>Code coverage report for src/cql-generators/select.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/cql-generators</a> select.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Table from "../table";
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (isString(constraint.subject) &amp;&amp; isString(constraint.value)) {
        return `${constraint.subject} = ${constraint.value}`;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new TypeError(`Malformed Input when constructing a IConstraint object. Given: ${constraint}.`);</span>
};
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (constraints.length &lt; 1) <span class="cstat-no" title="statement not covered" >return "";</span>
&nbsp;
