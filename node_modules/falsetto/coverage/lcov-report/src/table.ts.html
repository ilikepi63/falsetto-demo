...
<head>
    <title>Code coverage report for src/table.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> table.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Schema from "./schema";
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (process.env.GENERATE_TABLES) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    createTable(</span>): string {
<span class="cstat-no" title="statement not covered" >        return createTable(this);</span>
    }
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >    get(</span>attributes?: Array&lt;string&gt;): Query {
<span class="cstat-no" title="statement not covered" >        return new Query({ table: this, attributes });</span>
    }
}
&nbsp;
&nbsp;
